...
yad --info --borders=32 --fixed --center --undecorated --text="O Office 365 foi instalado com sucesso! \n" --modal   --width=380 --button="Ok":0 --borders=32 --fixed --center --undecorated 
